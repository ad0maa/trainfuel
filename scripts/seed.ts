...
// Manually apply seeds via the `npx cedar prisma db seed` command.
//
// Seeds automatically run the first time you run the `npx cedar prisma migrate dev`
// command and every time you run the `npx cedar prisma migrate reset` command.
//
